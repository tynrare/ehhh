 ...
 */
class PaperioPointsCase2 extends Thingy {
	/**
	 * .
	 */
	async initCallback() {
	...
	run() {
		...
		this.zones.points.events.on('inserted_point_crossed', (prev, point) => {
	...
	case1() {
		...
		//this.zones.rayToNextPoint(new Vector3(-0.5, 0, -0.5), dir, false);
		//this.zones.rayToNextPoint(new Vector3(0.5, 0, -0.5), dir);

		this.zones.drawInitialZone(new Vector3(0, 0, 0), dir);
	}
}

export default PaperioPointsCase2;
